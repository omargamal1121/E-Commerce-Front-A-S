  ...
  const testApiConnection = async () => {
    ...
    try {
      ...
      if (testType === 'products') {
        ...
        response = await fetch(`${backendUrl}/api/Products?isActive=true&includeDeleted=false&page=1&pageSize=5`);
        ...
        response = await fetch(`${backendUrl}/api/categories?isActive=true&isDeleted=false`);
        data = await response.json();
        ...
        response = await fetch(`${backendUrl}/api/subcategories?isActive=true&isDeleted=false`);
        data = await response.json();
